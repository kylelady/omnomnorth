...
class Ugos(Restaurant):
    ...
    summer_hours = {'open': {'hour': 8, 'min': 0}, 'close': {'hour': 20, 'min': 0}}
    summer_fri_hours = {'open': {'hour': 8, 'min': 0}, 'close': {'hour': 18, 'min': 0}}
    reg_hours = {'open': {'hour': 8, 'min': 0}, 'close': {'hour': 24, 'min': 0}}
    reg_night_hours = {'open': {'hour': 0, 'min': 0}, 'close': {'hour': 1, 'min': 0}}
    reg_fri_hours = {'open': {'hour': 10, 'min': 0}, 'close': {'hour': 20, 'min': 0}}
    reg_sat_hours = {'open': {'hour': 10, 'min': 0}, 'close': {'hour': 20, 'min': 0}}
    reg_sun_hours = {'open': {'hour': 12, 'min': 0}, 'close': {'hour': 20, 'min': 0}}
