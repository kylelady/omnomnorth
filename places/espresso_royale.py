...
class EspressoRoyale(Restaurant):
    ...
    reg_hours= {'open': {'hour': 6, 'min': 0}, 'close': {'hour': 22, 'min': 0}}
    reg_sat_hours= {'open': {'hour': 7, 'min': 0}, 'close': {'hour': 22, 'min': 0}}
    reg_sun_hours= {'open': {'hour': 8, 'min': 0}, 'close': {'hour': 22, 'min': 0}}
