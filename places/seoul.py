...
class SeoulStreet(Restaurant):
    ...
    reg_hours= {'open': {'hour': 11, 'min': 0}, 'close': {'hour': 22, 'min': 15}}
    reg_fri_sat_hours= {'open': {'hour': 11, 'min': 0}, 'close': {'hour': 23, 'min': 45}}
